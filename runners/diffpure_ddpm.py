...
class Diffusion(torch.nn.Module):
    def __init__(self, args, config, device=None):
        ...
        elif self.config.data.dataset == "DegradedFaces":
            print("degraded faces, loading CelebA_HQ ckpt")
            url = "https://image-editing-test-12345.s3-us-west-2.amazonaws.com/checkpoints/celeba_hq.ckpt"
        else:
            raise ValueError
    ...
    def image_editing_sample(self, img=None, bs_id=0, tag=None):
        ...
        # convert to BxCxHxW, and convert to float32 or else errors downstream
        ...
        with torch.no_grad():
            ...
            if bs_id < 2:
                ...
                tvu.save_image(
                    (x0 + 1) * 0.5, os.path.join(out_dir, "original_input_gpu{}.png".format(x0.get_device())))
            ...
            for it in range(self.args.sample_step):
                ...
                if bs_id < 2:
                    tvu.save_image(
                        (x + 1) * 0.5, os.path.join(out_dir, "init{}_gpu{}.png".format(it, x.get_device())))
                ...
                for i in reversed(range(total_noise_levels)):
                    ...
                    if (i - 49) % 50 == 0 and bs_id < 2:
                        tvu.save_image(
                            (x + 1) * 0.5, os.path.join(out_dir, "noise_t{}_it{}_gpu{}.png".format(i, it, x.get_device())))
                ...
                if bs_id < 2:
                    ...
                    tvu.save_image(
                        (x0 + 1) * 0.5, os.path.join(out_dir, "samples_it{}_gpu{}.png".format(it, x0.get_device())))
